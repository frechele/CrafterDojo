...
from crafterdojo.lib.VPTPPO.buffer import VPTBuffer


class VPTPPO(RecurrentPPO):
    def __init__(self, *args, kl_coef=0.195, kl_decay=0.9995, log_dir=None, **kwargs):
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                actions, values, log_probs, vpt_states = self.policy.forward(obs_tensor, vpt_states, episode_starts)
            ...
            # if done, stable_baseline3 vec_env will automatically call reset() in step()
            ...
            for idx, done_ in enumerate(dones):
                #if done_:
                #    print(infos[idx].get("TimeLimit.truncated", False))
                if (
                    done_
                    ...
                    with th.no_grad():
                        ...
                        terminal_value = self.policy.predict_values(terminal_obs, terminal_vpt_state, episode_starts)[0]
        ...
        with th.no_grad():
            ...
            values = self.policy.predict_values(obs_as_tensor(new_obs, self.device), vpt_states, episode_starts)
            ### VPT Changes End
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                grad_norm = th.nn.utils.get_total_norm([p.grad for p in self.policy.parameters() if p.grad is not None])
