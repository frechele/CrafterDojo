...
from crafterdojo.lib.steve1.data.text_alignment.vae import TranslatorVAE
...
def main(args):
    ...
    all_visual_embeddings = data['vid_embeddings']
    print("dataset shape:", all_text_embeddings.shape, all_visual_embeddings.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default='models/craftersteve1/csteve1_prior.pt')
